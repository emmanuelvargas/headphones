...
from deezercustom.resources import Album, Artist, Comment, Genre
from deezercustom.resources import Chart, Resource
from deezercustom.resources import Playlist, Radio, Track, User
