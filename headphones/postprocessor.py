    ...
    with postprocessor_lock:
        ...
        for album in snatched:
            if album['FolderName']:
                ...
                elif album['Kind'] == 'deezer':
                	download_dir = headphones.CONFIG.DEEZER_DIR
                else:
...
def forcePostProcess(dir=None, expand_subfolders=True, album_dir=None, keep_original_folder=False):
    ...
    if album_dir:
        ...
        if headphones.CONFIG.DEEZER and not dir:
            download_dirs.append(
                headphones.CONFIG.DEEZER_DIR.encode(headphones.SYS_ENCODING, 'replace'))
